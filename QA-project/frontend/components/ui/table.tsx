...
function TableFooter({ className, ...props }: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'bg-muted/75 border-t font-medium text-foreground [&>tr]:last:border-b-0',
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'hover:bg-muted data-[state=selected]:bg-muted border-b transition-colors text-foreground',
        className,
      )}
      {...props}
    />
