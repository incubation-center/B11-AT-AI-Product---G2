...
export default function DashboardOverviewPage() {
  ...
  const [dashboardState, setDashboardState] = useState<'loading' | 'empty' | 'populated'>('loading');
  ...
  return (
    <>
        ...
        <div className="dash-header-actions">
          {dashboardState !== 'loading' && (
            <>
              ...
              <Link href="/dashboard/upload" className="dash-btn dash-btn-primary">
                + Upload Data
              </Link>
            </>
          )}
      ...
      <div style={{ position: 'fixed', bottom: '20px', right: '20px', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: '8px', padding: '10px', display: 'flex', gap: '8px', zIndex: 100 }}>
        <span style={{ fontSize: '12px', color: 'var(--ink3)', alignSelf: 'center', marginRight: '4px' }}>Dev Toggle:</span>
        <button onClick={() => setDashboardState('loading')} style={{ background: 'var(--bg)', color: 'var(--ink2)', border: '1px solid var(--border)', padding: '4px 8px', fontSize: '11px', borderRadius: '4px', cursor: 'pointer' }}>Loading</button>
        <button onClick={() => setDashboardState('empty')} style={{ background: 'var(--bg)', color: 'var(--ink2)', border: '1px solid var(--border)', padding: '4px 8px', fontSize: '11px', borderRadius: '4px', cursor: 'pointer' }}>Empty</button>
        <button onClick={() => setDashboardState('populated')} style={{ background: 'var(--bg)', color: 'var(--ink2)', border: '1px solid var(--border)', padding: '4px 8px', fontSize: '11px', borderRadius: '4px', cursor: 'pointer' }}>Populated</button>
      </div>
    </>
  );
}
      ...
      <div className="metric-grid">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="metric-card" style={{ height: '110px' }}>
            <div className="skeleton-shimmer" style={{ width: '60%', height: '12px', marginBottom: '16px' }}></div>
            <div className="skeleton-shimmer" style={{ width: '40%', height: '32px', marginBottom: '12px' }}></div>
            <div className="skeleton-shimmer" style={{ width: '70%', height: '10px' }}></div>
          </div>
        ))}
      </div>
      <div className="charts-grid">
        <div className="chart-card" style={{ height: '320px' }}>
          <div className="skeleton-shimmer" style={{ width: '40%', height: '14px', marginBottom: '32px' }}></div>
          <div className="skeleton-shimmer" style={{ width: '100%', height: '200px' }}></div>
        </div>
        <div className="chart-card" style={{ height: '320px' }}>
          <div className="skeleton-shimmer" style={{ width: '50%', height: '14px', marginBottom: '32px' }}></div>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '24px' }}>
             <div className="skeleton-shimmer" style={{ width: '120px', height: '120px', borderRadius: '50%' }}></div>
          </div>
          <div className="skeleton-shimmer" style={{ width: '80%', height: '10px', margin: '0 auto 12px' }}></div>
          <div className="skeleton-shimmer" style={{ width: '60%', height: '10px', margin: '0 auto' }}></div>
        </div>
      </div>
    </>
  );
  ...
  return (
    <div className="empty-state-card">
      ...
      <p className="esc-desc">
        Your dashboard is looking a bit empty. Upload your first test execution dataset or Jira bug export to generate AI-powered insights.
      </p>
      ...
      <div className="onboarding-list">
        ...
        <div className="ol-item">
          ...
          <div className="ol-text">
            ...
            <Link href="/dashboard/upload" style={{ color: 'var(--teal)', fontSize: '13px', marginLeft: '12px', textDecoration: 'none' }}>Go to Upload →</Link>
          </div>
        </div>
        <div className="ol-item">
          <div className="ol-icon t-pending"></div>
          <div className="ol-text" style={{ color: 'var(--ink3)' }}>Analyze root causes with AI Chat</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <>
        ...
        <div className="chart-card">
          ...
          <div className="donut-legend">
            <div className="dl-item">
              ...
              <span style={{ fontFamily: '"JetBrains Mono", monospace' }}>35%</span>
            </div>
            <div className="dl-item">
              <div className="dl-left">
              ...
              <span style={{ fontFamily: '"JetBrains Mono", monospace' }}>25%</span>
            </div>
            <div className="dl-item">
              <div className="dl-left">
              ...
              <span style={{ fontFamily: '"JetBrains Mono", monospace' }}>20%</span>
            </div>
            <div className="dl-item">
              <div className="dl-left">
      ...
      <div className="activity-card">
        <div className="cc-header" style={{ marginBottom: '16px' }}>Recent Activity</div>
        <div className="ac-list">
          <div className="ac-item">
            <div className="ac-dot coral"></div>
            <div className="ac-content">
              <div className="ac-text">AI automatically flagged a critical authentication flaw in <strong style={{ color: 'var(--ink)' }}>PR-1025</strong></div>
          ...
          <div className="ac-item">
            ...
            <div className="ac-content">
              <div className="ac-text">User <strong>Alex Chen</strong> uploaded new dataset <em>"Q1_Regression_Results.csv"</em></div>
          ...
          <div className="ac-item">
            ...
            <div className="ac-content">
              <div className="ac-text">Weekly automated risk report generated. 3 new medium risks identified in Billing module.</div>
