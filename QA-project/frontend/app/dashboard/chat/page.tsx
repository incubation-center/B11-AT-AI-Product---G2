...
export default function ChatPage() {
  ...
  const renderActiveChat = () => {
    if (activeChat === 'new') {
      return (
        <div className="ai-chat-area" style={{ justifyContent: 'center', alignItems: 'center' }}>
      ...
      return (
        <div className="ai-chat-area">
          ...
          <div className="ai-msg bot animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            ...
            <div style={{ background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: '8px', padding: '16px', color: 'var(--ink)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                ...
                <div style={{ flex: 1, height: '6px', background: 'var(--surface3)', borderRadius: '3px', overflow: 'hidden' }}>
                  <div style={{ height: '100%', background: 'var(--coral)', width: '92%', borderRadius: '3px' }}></div>
                </div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                ...
                <div style={{ flex: 1, height: '6px', background: 'var(--surface3)', borderRadius: '3px', overflow: 'hidden' }}>
                  <div style={{ height: '100%', background: 'var(--amber)', width: '78%', borderRadius: '3px' }}></div>
                </div>
    ...
    if (activeChat === 'coverage') {
      return (
        <div className="ai-chat-area">
          <div className="ai-msg user animate-fade-in">
            Can you show me our current test coverage gaps?
          </div>
          <div className="ai-msg bot animate-fade-in" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            ...
            <div className="ai-input-box">
              ...
              <div className="ai-input-toolbar">
                ...
                <div className="ai-toolbar-right">
                  ...
                  >
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ transform: 'rotate(0deg)' }}>
